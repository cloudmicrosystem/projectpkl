    ...
    <div class="card-body">
        <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control form-control-solid" id="noArsip" type="text" placeholder="Nomor Arsip" name="noArsip" required/>
            </div>
            <div class="mb-3">
                <label class="font-weight-bold" for="namaArsip">Nama Arsip</label>
                <input class="form-control form-control-solid" id="namaArsip" type="text" placeholder="Nama Arsip" name="namaArsip" required/>
            </div>
            <div class="mb-3">
